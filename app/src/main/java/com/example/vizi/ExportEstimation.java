...
public class ExportEstimation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        subTitle.setText(R.string.export_estimation);
        ...
        json = SharedHelper.getJSON(this, "export_monthly.json");
        try {
            jsonMonth = json.getJSONObject("2020-02");
        ...
        yearSlider.addOnSliderTouchListener(new Slider.OnSliderTouchListener() {
            ...
            public void onStopTrackingTouch(@NonNull Slider slider) {
                ...
                series.data(SharedHelper.getData(ExportEstimation.this, jsonMonth));
            }
        });
    }
