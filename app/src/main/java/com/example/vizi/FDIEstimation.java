...
public class FDIEstimation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        subTitle.setText(R.string.fdi_estimation);
        ...
        json = SharedHelper.getJSON(this, "fdi_monthly.json");
        try {
        ...
        yearSlider.addOnSliderTouchListener(new Slider.OnSliderTouchListener() {
            ...
            public void onStopTrackingTouch(@NonNull Slider slider) {
                ...
                series.data(SharedHelper.getData(FDIEstimation.this, jsonMonth));
            }
        });
    }
